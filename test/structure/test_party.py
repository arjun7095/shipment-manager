...
class StructureTestSuite(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.MODULE = app.party

    def test_class_exists_party(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"UGFydHk=").decode(),
            classes,
            msg=f"The class "
            f"`{base64.b64decode(b'UGFydHk=').decode()}` "
            f"is not found, but it was marked as required.",
        )

    def test_class_function_exists_party___init__(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"UGFydHk=").decode(),
            classes,
        ...
        functions = _get_class_function_names(
            self.MODULE, base64.b64decode(b"UGFydHk=").decode()
        )
        self.assertIn(
            base64.b64decode(b"UGFydHkuX19pbml0X18=").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'UGFydHkuX19pbml0X18=').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'UGFydHk=').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_party___init__(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"UGFydHk=").decode(),
            classes,
    ...
    def test_class_function_exists_party_validate(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"UGFydHk=").decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b"UGFydHkudmFsaWRhdGU=").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'UGFydHkudmFsaWRhdGU=').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'UGFydHk=').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_party_validate(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"UGFydHk=").decode(),
            classes,
